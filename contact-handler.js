// MadeRidge Website Design -- contact form endpoint.
// Server-side validation and sanitization is authoritative. Client-side
// validation in js/main.js is a UX convenience only and is never trusted here.
...
async function handleContactSubmit(req, res) {
  // 1. CSRF check (in addition to the CSRF middleware validating csrf_token
