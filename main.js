// MadeRidge Website Design -- shared site behavior.
...
function wireContactForm() {
  ...
  form.addEventListener("submit", async (event) => {
    ...
    // authoritative validation and sanitization (see server/contact-handler.js).
    let valid = true;
    ...
    if (!message.value.trim()) {
      showError("message-error", "Please describe your project.");
      valid = false;
    }
